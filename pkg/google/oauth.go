...
func (data *googleOauthUser) formatUser() entity.User {
	return entity.User{
		Email:    data.Email,
		Username: data.Name,
	}
...
func (data *googleOauthUser) formatOauth(accessToken string, refreshToken string) entity.UserOauth {
...
func (g *googleOauth) GetUserFromCode(ctx context.Context, code string) (entity.User, entity.UserOauth, error) {
